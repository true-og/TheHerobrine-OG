    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args == null || args.length == 0) {
            if (gm.getPassUser() == null)
                ...
                sender.sendMessage(Message.format(ChatColor.YELLOW
                        + gm.getPassUser().getName() + ChatColor.RESET + " will no-longer be Herobrine."));
                gm.setPassUser(null);
            }
            return true;
        }
        ...
        sender.sendMessage(
                Message.format(ChatColor.YELLOW + player.getName() + ChatColor.RESET + " will be Herobrine."));
        return true;
    }
}
