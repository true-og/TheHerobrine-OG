...
public class PlayerUtil {
    ...
    public static void broadcastTitle(GameLobby gameLobby, String top, String bottom, int fadeIn, int stay,
            int fadeOut)
    {
    ...
    public static void addEffect(Player player, PotionEffectType type, int duration, int amplifier, boolean particles,
            boolean icon)
    {
    ...
    public static Player randomPlayer(GameLobby gameLobby) {
        ...
        Player player = (Player) gameLobby.getGameManager().getSurvivors().toArray()[random
                .nextInt(gameLobby.getGameManager().getSurvivors().size())];
