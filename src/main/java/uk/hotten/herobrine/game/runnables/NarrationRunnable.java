        ...
        switch (gm.getShardState()) {
            ...
            case WAITING: {
                ...
                if (firstMsg())
                    ...
                    separate("&cBEWARE: The Herobrine is still a cloud of smoke!", "&bTry eliminate all the Survivors",
            ...
            case CARRYING: {
                ...
                if (firstMsg())
                    ...
                    separate("&aProtect your shard carrier", "&bKill the shard carrier first!",
                            "&eYou're out of the game! Left-click to spectate.");
                break;
            ...
            case INACTIVE: {
                ...
                separate("&cKill the Herobrine!", "&aYou are now visible!",
                        "&eYou're out of the game! Left-click to spectate.");
                break;
