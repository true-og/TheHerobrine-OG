...
public class PriestKit extends Kit {
    ...
    public PriestKit(GameManager gm, boolean requirePermission) {
        ...
        super(gm, "priest", "&fPriest", "theherobrine.kit.classic.priest", requirePermission,
                Message.createArray("&8- &aBlade of Heroism &8&o(weapon)", "", "&8- &aDreamweaver Bandage &8&o(x2)",
                        "   &7&oBandage yourself to full health", "   ", "&8- &aNotch's Wisdom &8&o(x2)",
                        "   &7&oCreates an aura of health to", "   &7&oheal survivors for 10 seconds", "",
                        "&8- &bSummon Woofless &8&o(x1)", "   &7&oIt's dangerous to go alone, take a friend!"),
