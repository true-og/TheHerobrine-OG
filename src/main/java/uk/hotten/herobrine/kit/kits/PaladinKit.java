...
public class PaladinKit extends Kit {
    ...
    public PaladinKit(GameManager gm, boolean requirePermission) {
        ...
        super(gm, "paladin", "&6Paladin", "theherobrine.kit.unlockable.paladin", requirePermission,
                Message.createArray("&8- &aPaladin's Might &8&o(weapon)", "", "&8- &bProtection &lSpirit! &8&o(x3)",
                        "   &7&oProtect yourself with a spirit of", "   &7&orapid healing for 12 seconds", "",
                        "&8- &aNotch's Wisdom &8&o(x3)", "   &7&oCreates an aura of health to",
